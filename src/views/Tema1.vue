  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mb-5(data-aos="flip-up")
      .col-lg-10
        .cajon.color-primario.p-4
          p.mb-0 Blender facilita hacer el #[i rig] a partir del uso de #[i addons] propios del programa, utilizando una malla utilizando el #[i Addon Rigify]; en el siguiente recurso de aprendizaje se podrá ver la forma de implementarlo.
    ...
    LineaTiempoD.color-primario(data-aos="flip-up")
      .row(numero="1" titulo="paso 1") 
        .col-lg-12
          p.mb-5 Ir a la pestaña #[i edit - preferences] y buscar #[i addons] en la pestaña #[i addons], en el buscador escribir #[i rigg], y aparecerá #[i rigging: rigify], el cual se activa, esto se muestra en la figura que aparece a continuación. 
      ...
      .row(numero="2" titulo="Paso 2")
        .col-lg-12
          p.mb-5 El paso siguiente es ir al modo objeto y dar clic en la pestaña #[i add – armatura – basic- mbasic metarigg], con esto, se agrega un esqueleto humanoide a la escena, dicho proceso se puede observar en la siguiente figura.
      ...
      .row(numero="4" titulo="Paso 4")
        .col-lg-12
          p.mb-5 Luego en el modo edición, se acomodan los huesos para que compaginen con las partes del cuerpo del personaje, esto se realiza seleccionando el hueso que se quiere modificar y se le da mover con la tecla G. Hay que tener en cuenta que si se activa en las opciones de #[i tool x-axis mirror], lo que se haga en un lado se replicará en el otro, por ende, se ahorra la tarea de acomodar los huesos en la otra mitad del cuerpo, este proceso se muestra en la figura 5.
    ...
    separador
    .titulo-segundo(data-aos="flip-up")
      #t_1_2.h2 1.2 #[i Autorig]
    
    .row.justify-content-center.mb-5(data-aos="flip-up")
      .col-lg-10
        .cajon.color-acento-contenido.p-4
          p.mb-0 Se puede generar #[i rig] automatizado mediante el uso de programas externos, en este caso se utilizará, Mixamo de Adobe, esta es una plataforma en línea a la que se deben subir los modelados para allí asignarles el #[i rig] y el #[i skinning]. En el siguiente video sobre “#[i Autorig Mixamo]” se podrá encontrar información que permitirá profundizar en el tema y adquirir los conocimientos necesarios para poder con la práctica desarrollar las competencias que requiere. 
    ...
    LineaTiempoD.color-primario(data-aos="flip-up")
      .row(numero="1" titulo="paso 1") 
        .col-lg-12
          p.mb-5 Para iniciar, se debe copiar el enlace en el navegador, ir a la página   
            a(href="https://www.mixamo.com" target="_blank").link-color https://www.mixamo.com  
      ...
      .row(numero="2" titulo="Paso 2")
        .col-lg-12
          p.mb-5 Al estar en el #[i software] se debe ingresar al panel para subir el modelo en #[i fbx] sin esqueletos, es decir solo la malla, luego hacer clic donde dice #[i upload character]; para aclarar los conceptos se pueden revisar las figuras 11 y 12.
              ...
              .col-lg-12
                ...
                .row.justify-content-center
                  .col-lg-10
                    ...
                    p En esta imagen se observa el botón para cargar el modelo, al cual se le agrega el #[i rig] automático.
            .row.justify-content-center
              .col-lg-12
                .row.justify-content-center.mb-3
                  .col-lg-3
                ...
                .row.justify-content-center
                  .col-lg-10
                    ...
                    p.mb-0 Aquí se observa que el personaje se ha cargado en la página y está listo para realizarle el proceso de #[i autorig].
                    p Luego se hace clic en #[i next] y emergerá una pantalla con herramientas circulares, esos puntos son los que se deben acomodar en el personaje según la figura 13 que aparece como ejemplo. 
            .row.justify-content-center
              .col-lg-12
                .row.justify-content-center.mb-3
                  .col-lg-4
                ...
                .row.justify-content-center
                  .col-lg-10
                    ...
                    p Después debe hacer nuevamente clic sobre #[i next] y Mixamo empezará el trabajo de #[i rig]. Se debe esperar mientras se surte el proceso, una vez terminado se podrá ver que el personaje aparece con una animación #[i idle] de prueba, así se constata que quedó completo el #[i rig]. Se invita a revisar la figura 14 para verificar la ubicación de los elementos en la herramienta.
            .row.justify-content-center
              .col-lg-12
                .row.justify-content-center.mb-3
                  .col-lg-4
                ...
                .row.justify-content-center
                  .col-lg-10
                    ...
                    p Mixamo tiene animaciones prediseñadas, simplemente se hace clic en la que desea utilizar y se verá aplicada en el personaje; una vez seleccionada, se hace clic en el botón #[i download] y se tendrá el #[i rigg] con la animación en un archivo #[i fbx], a continuación, se muestra una figura que ayudará a entender el proceso.
            .row.justify-content-center
              .col-lg-12
                .row.justify-content-center.mb-3
                  .col-lg-3
                ...
                .row.justify-content-center
                  .col-lg-10
                    ...
                    p En esta imagen se ve el personaje con movimientos preestablecidos, y el botón de descarga, el cual generará un archivo .#[i fbx].
    ...
    LineaTiempoD.color-acento-contenido(data-aos="flip-up")
      .row(numero="1" titulo="paso 1") 
        .col-lg-12
          h5 #[i Skinning] y pesos para #[i Addon Rigify]
      ...
      .row(numero="4" titulo="Paso 4")
        .col-lg-12
          p Con la herramienta #[i Draw] se comienzan a pintar los pesos de la malla; cuando se pinta lo que se ve más rojo es lo que tiene mayor peso, lo que está en azul tiene peso nulo y lo que está en verde posee peso moderado. 

          p.mb-5 Para pintar con más peso se deben aumentar los valores del #[i weight]; si quiere restar peso, el #[i weight] debe estar en 0. En la siguiente figura se podrá ver la afectación del peso en la muñeca del personaje #[i Flynn], donde el verde representa el peso de afectación media, y en el antebrazo se degrada hasta azul para mostrar una transición en la que el movimiento de la muñeca afectará mínimamente el antebrazo.
